...
spa.chat = (function () {
	...
	// 	*	people_model - the people model objetc which provides
	//		methods to manage the list of people the model mantains
	...
	// Purpose : 
	//	Directs chat to offer its capaility to the user
	// Arguments :
	...
	//	it with HTML content. It then initialize elements,
	...
	//these are standard methods for nearly all featured modules
	return { 
